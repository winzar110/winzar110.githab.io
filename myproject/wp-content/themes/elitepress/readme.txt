...
About:
ElitePress a theme for business, consultancy firms etc  by Webriti (Author URI: http://www.webriti.com). 
...
3. Add featured-images, blog, footer-widgets Tag.
@version 1.4
...
ElitePress WordPress Theme, Copyright 2015 Priyanshu Mittal
...
ElitePress WordPress Theme bundles the following third-party resources:
