...
*   Exit popup - catch your usersâ€™ attention when they decide to leave your site without doing any of the things you want them to do. Exit popups can briefly interrupt them with a popup message, steering them towards a singular call to action.
...
*   Create contact form popup â€“ this type will allow your clients to write you a message right from the popup.
...
As far as the popup accessibility on different devices is freely manageable too, itâ€™s quite responsive and is resized accordingly.
