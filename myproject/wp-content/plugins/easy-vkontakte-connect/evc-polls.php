...
*/
  $p['evc_widget_community_messages'] = array(
      'target' => '#toplevel_page_evc',
      'options' => array(
          'content' => sprintf( '<h3> %s </h3> <p> %s </p>',
              __( 'ВК Виджет "Сообщения сообществ"' ,'evc'),
              __( 'Сервис моментальных сообщений от ВКонтакте для общений с посетителями сайта, поможет удержать клиентов и повысить конверсию.<br/><a href = "'.admin_url('admin.php?page=evc-widgets#evc_widget_community_messages').'">Настройки здесь</a>.','evc')
          ),
          'position' => array( 'edge' => 'left', 'align' => 'right' )
      )
  );
