...
function evc_stats_page() {
	...
	<div class="wrap">
		...
		$refresh_g_url = remove_query_arg( array(
			'refresh_w',
			'refresh',
			'captcha_key',
			'captcha_sid'
		...
		<div class="bootstrap-wpadmin" id="evc">
			...
			<div class="media a02" id="evc">
				...
				<div class="media-body ">
					...
					<p><strong>Сайт:</strong>
						<a href="http://<?php echo $vk_gdata['url']; ?>"><?php echo $vk_groupa['screen_name']; ?></a>
						<br/><strong>Подписчиков:</strong> <?php echo number_format( $vk_groupa['members_count'], 0, '.', ' ' ); ?>
						<br/>
						<small class="muted">Refresh: <?php echo human_time_diff( $vk_groupa['timestamp'], current_time( 'timestamp', 1 ) ); ?> ago (<a href="<?php echo $refresh_g_url; ?>">refresh</a>)
						</small>
					</p>
				</div>
			</div>
					...
					<div class="navbar-inner">
						<div class="container">
							...
							<ul class="nav evc-stats-options" data-option-key="sortBy">
								<li>
									<a href="javascript:void(0)" class="external totop" rel="tooltip" data-original-title="Наверх" data-placement="bottom"><i class="icon-circle-arrow-up icon"></i></a>
								</li>
								<li class="active" data-key="sortBy" data-option-value="date">
									<a data-value="dates" href="javascript:void(0)" rel="tooltip" data-original-title="Сортировать по времени публикации" data-placement="bottom"><i class="icon-time icon"></i></a>
								</li>
								<li data-key="sortBy" data-option-value="likes">
									<a data-value="likes" href="javascript:void(0)" rel="tooltip" data-original-title="Сортировать по лайкам" data-placement="bottom"><i class="icon-heart icon"></i></a>
								</li>
								<li data-key="sortBy" data-option-value="reposts">
									<a data-value="reposts" href="javascript:void(0)" data-placement="bottom" rel="tooltip" data-original-title="Сортировать по репостам"><i class="icon-bullhorn icon"></i></a>
								</li>
								<li data-key="sortBy" data-option-value="comments">
									<a data-value="comments" href="javascript:void(0)" data-placement="bottom" rel="tooltip" data-original-title="Сортировать по комментариям"><i class="icon-comment icon"></i></a>
								</li>

								<li class="divider-vertical"></li>

								<li data-key="sortAscending">
									<a data-value="true" href="javascript:void(0)" data-placement="bottom" rel="tooltip" data-original-title="Сортировать по возрастанию"><i class="icon-arrow-down icon"></i></a>
								</li>
								<li data-key="sortAscending" class="active">
									<a data-value="false" href="javascript:void(0)" data-placement="bottom" rel="tooltip" data-original-title="Сортировать по убыванию"><i class="icon-arrow-up icon"></i></a>
								</li>

								<li class="divider-vertical"></li>

								<li>
									<a href="http://ukraya.ru/58/reshenie-problem-po-rabote-s-plaginom-easy-vkontakte-connect-evc-1-0" data-placement="bottom" rel="tooltip" data-original-title="Помощь" class="external"><i class="icon-question-sign icon"></i></a>
								</li>
							</ul>
								...
								<li>
									<form class="navbar-form pull-left" method="get" action="">
										...
										<div class="input-append">
											...
											<button class="btn" type="submit"><i class="icon-arrow-right icon"></i>
											</button>
										</div>
									</form>
								</li>
								<li class="dropdown">
									<a data-toggle="dropdown" class="dropdown-toggle" href="#">Все группы
										<b class="caret"></b></a>
			...
			if ( is_numeric( $gid ) ) {
				...
				if ( $refresh_w ) {
					$refresh_w_url = remove_query_arg( array(
						'refresh_g',
						'refresh',
						'captcha_key',
						'captcha_sid'
...
function evc_stats_get_group_posts_refresh_time( $gid ) {
	...
	if ( false === ( $evc_wall_posts_cache = get_transient( 'evc-w_' . $gid ) ) ) {
		return false;
	}
...
function evc_stats_get_group( $gid ) {
	...
	$gid = $gid < 0 ? - 1 * $gid : $gid;
	if ( false === ( $evc_vk_group = get_transient( 'evc-g_' . $gid ) ) ) {
		return false;
	}
